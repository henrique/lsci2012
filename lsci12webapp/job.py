...
class Job(db.Model):
    ...
    def __repr__(self):
        return "jobId: "+str(self.jobId)+" iteration: "+str(self.iteration)+" vmIp: "+str(self.vmIp)+" paraSigma: "+str(self.paraSigma)+" paraEA:"+str(self.paraEA)+" running: "+str(self.running)+" finished: "+str(self.finished)+" result: "+str(self.result)+" counter: "+str(self.counter)
